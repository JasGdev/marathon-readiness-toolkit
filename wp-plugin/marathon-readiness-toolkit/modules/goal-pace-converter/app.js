(() => {
    const root = document.querySelector("#goal-pace-converter");
    if (!root) return;
    ...
    // ---------- DOM ----------
    const distanceEl = root.querySelector("#gpc-distance");
    const hoursEl = root.querySelector("#gpc-hours");
    const minutesEl = root.querySelector("#gpc-minutes");
    const secondsEl = root.querySelector("#gpc-seconds");
    const btnEl = root.querySelector("#gpc-calc-btn");
    const outputEl = root.querySelector("#gpc-output");
    const noteEl = root.querySelector("#gpc-note");
